...
ENTITY_MARKERS = (
    ...
    "mhc", "mutual holding company", "coöperatief", "cooperatief", "coöperatieve", "cooperatieve",
    "ag", "srl", "s.r.l.",
)
INSTITUTION_MARKERS = (
...
FUND_MARKERS = (
    "fund", "funds", "capital", "ventures", "partners", "partnership",
    "lp", "l.p", "l.p.", "slp", "s.l.p", "s.l.p.",
)
