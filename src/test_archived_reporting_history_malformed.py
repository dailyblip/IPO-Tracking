...
class ArchivedReportingHistoryMalformedTests(unittest.TestCase):
    @staticmethod
    def _submissions():
        return {
            "filings": {
    ...
    def test_misaligned_recent_form_date_arrays_fail_closed(self):
    ...
    def test_misaligned_archive_form_date_arrays_fail_closed(self):
        submissions = self._submissions()
        archived = {
            "form": ["10-K", "8-K"],
    ...
    def test_invalid_archive_filing_date_fails_closed(self):
        submissions = self._submissions()
        archived = {
            "form": ["10-K"],
    ...
    def test_malformed_recent_chronology_blocks_final_release(self):
        queue = {
            "filings": [
                {
                    "id": "final-malformed-history",
                    "company": "Malformed History Co",
                    "cik": "1",
                    "form": "424B4",
                    "stage": "Priced",
                    "filed": "2026-09-02",
