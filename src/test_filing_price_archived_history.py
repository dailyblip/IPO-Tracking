...
class ArchivedFilingPriceHistoryTests(unittest.TestCase):
    ...
    def test_duplicate_accession_keeps_known_file_number(self):
        submissions = self.submissions()
        submissions["filings"]["files"][0]["filingTo"] = "2026-08-18"
        archive = {
            "form": ["S-1/A"],
        ...
        self.assertEqual(history[0]["file_number"], "333-300001")
    ...
    def test_duplicate_accession_conflict_fails_closed(self):
        ...
        self.assertIn("conflicting duplicate accession metadata", str(error.exception))
        self.assertIn("0001234567-26-000003", str(error.exception))
