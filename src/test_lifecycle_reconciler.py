...
class LifecycleReconcilerTests(unittest.TestCase):
    ...
    def test_promotes_stale_prepricing_record_from_final_424b4(self):
        ...
        self.assertEqual(promoted["filed"], "2026-08-19")
        self.assertIsNone(promoted["pricing_date"])
    ...
    def test_final_424b4_with_unresolved_exact_size_keeps_priced_ipo_and_drops_stale_prepricing(self):
        ...
        self.assertEqual(result["form"], "424B4")
        self.assertEqual(result["stage"], "Priced")
        self.assertEqual(result["filed"], "2026-08-19")
        self.assertIsNone(result["pricing_date"])
        self.assertEqual(result["offering_price"], 17.5)
